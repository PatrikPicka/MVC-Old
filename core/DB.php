...
class DB {
	...
	private function __construct(){						//constructor seskládá automaticky(je spuštěn když je voláná class) propojení 														k databázi private aby se nemohla volat dokola
	...
	public static function getInstance () {				//zpřístupňuje přístup k databázi, hlavní funkce při komunikaci s databází
	...
	public function query($sql, $params = array()){				//funkce query může být použita pro sql příkaz když komunikujeme s databází
		$this->_error = false;								
